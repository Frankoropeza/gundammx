...
sucursales:
  - etiqueta: Gran Plaza, local I-22
    ciudad: Mazatlán
    estado: sinaloa
    dentro_de_plaza: Gran Plaza Mazatlán
...
evidencias:
  ...
  - afirmacion: Su local está en Gran Plaza Mazatlán, local I-22
    ...
    fecha: '2026-09-04'
    vigencia_meses: 12
  - afirmacion: Ofrece apartado en preventa con pago diferido
    url: https://www.tooys.mx/
    cita: 'Copy del sitio: "Aparta en PreVenta, Paga Comodamente"'
    fecha: '2026-09-07'
    vigencia_meses: 6
  - afirmacion: 'No se pudo confirmar surtido específico de Gunpla: no publica categoría ni colección de Gundam identificable'
    url: https://www.tooys.mx/
...
faq:
  ...
  - pregunta: ¿Por qué aparece en el directorio si no está confirmado?
    respuesta: >-
      Porque cubre Mazatlán, una plaza sin otras opciones verificadas, y porque es mejor listarla con la
      advertencia puesta que dejar el estado en blanco. Su verificación está en "sin verificar" y su
      nivel de confianza en uno de tres, que es lo más bajo del directorio.
  - pregunta: ¿Dónde está?
    respuesta: >-
      En Gran Plaza Mazatlán, local I-22. No publica calle, código postal, teléfono ni horarios en la
      información que pudimos consultar.
verificacion:
...
Gunpla, y aquí no lo damos por hecho. Por eso su oferta se declara como desconocida, la ficha no lista
ningún grado, su verificación se queda en "sin verificar" y su nivel de confianza es uno de tres, el más
bajo del directorio. Al migrar la ficha al estándar nuevo su sitio no respondió a nuestra consulta en
dos intentos, así que tampoco pudimos refrescar el expediente. Si compras ahí y confirmas que maneja
Gunpla, <a href="/reportar/">repórtalo</a> y actualizamos la ficha con tu dato.
